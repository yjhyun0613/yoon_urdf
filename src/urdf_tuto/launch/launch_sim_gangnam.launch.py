...
def generate_launch_description():
    ...
    # Set GAZEBO_MODEL_PATH so Gazebo can find model://gangnam_world and model://cpr_office
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={'world': os.path.join(get_package_share_directory("urdf_tuto"), 'world', 'gangnam.world')}.items(),
    )
    ...
    spawn_entity = Node(
        ...
        arguments=["-topic", "robot_description", "-entity", "with_robot", "-timeout", "300"],
        output="screen",
    )
